...
public class MainElectrodomesticos {
	...
	public static void main(String[] args) {
		...
		System.out.println("*****************************");	
		System.out.println(" A continuacion se mostrará de que clase pertence el Objeto");
		System.out.println("  ");
		...
		System.out.println("*****************************");	
		System.out.println(" Como la clase Lavadora y Televisón son hijas de la Clase Electrodomesticos"
		...
		System.out.println("*****************************");	
		System.out.println(" A continuacion se mostrará a que clase pertenece los objetos, "
		...
		System.out.println("*****************************");	
		System.out.println(" A continuacion se mostrará el valor del precio de"
		...
		*Segun su peso, consumo energetico. Además si es un Televisores por
		*Resolucion y sintetizador*/
		...
		System.out.println(" A continuacion se mostrar el valor del precio de los "
				...
				+"\n" + " peso, consumo energetico. Además si es un Televisores por la "
		...
		System.out.println("*****************************");	
		System.out.println("El precio de  los Electrodomesticos, que no son televisores o Lavadoras es  : " 
